        ...
        <div className="wrap">
          <div className="final rv">
            ...
            <div className="final-cta">
              <AppLink className="btn btn-gold btn-lg" href="/uye-ol?plan=premium&offer=founder" data-cta="final-primary">Kurucu üye ol · 149 ₺/ay</AppLink>
              <AppLink className="btn btn-ghost btn-lg" href="https://t.me/parena_official" data-cta="final-secondary">Önce topluluğa katıl</AppLink>
            </div>
