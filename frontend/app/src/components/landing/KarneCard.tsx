...
export function KarneCard() {
  return (
    <section className="rounded-[18px] border-t-[3px] border-gold bg-surface p-[22px] shadow-brand">
      ...
      {YESTERDAY_KARNE.map((row) => (
        <div
          key={row.ticker}
          className="flex items-center justify-between gap-3 border-b border-divider py-[9px] text-[12.5px] last:border-b-0"
        >
          ...
          <span
            className={`whitespace-nowrap rounded-full px-2 py-[3px] text-[10.5px] font-bold ${
